package epamqasejavaio;


import epamqasejavaio.model.DirScanner;
 ...
 * путь к директории, например "D:/movies". Записать в текстовый файл структуру папок
 * и файлов в виде, похожем на выполнение программы tree /F. Пример:
 * <p>
 * Amon Amarth
 * |-----2004 - Fate Of Norns
...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        if (baseDir.isDirectory()) {
            try {
                FileUtil.writeToResources("filetree.txt", dirScanner.scanDirectory(fileName, "", false));
        ...
        if (baseDir.isFile())
            dirScanner.showFileTreeSummary(fileName);
    }
}
